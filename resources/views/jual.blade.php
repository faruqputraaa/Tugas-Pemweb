...
@section('content')
    <form class="mx-4 md:mx-44">
        <div class="mt-28 flex flex-col mx-6">
            ...
            <input type="text" class="border-2 border-gray-400 rounded-md h-32 w-full md:w-2/3 p-8">
            ...
            <div class="flex flex-col md:flex-row w-full mb-10">
                <div class="md:w-1/2 flex flex-col justify-start px-6 mt-3">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            <input type="text" class="border-2 border-gray-400 rounded-md h-14 w-full p-4">
                            <label class="absolute bottom-12 bg-white left-3 text-xs text-black font-semibold px-1">Nomor
                                HP</label>
                        </div>
                        <small>supporting item</small>
                    </div>
                    ...
                    <button
                        class=" inline-block rounded-full py-3 w-4/5 mx-auto font-bold bg-white text-green-500 border-green-500 text-3xl mt-20 ml-auto shadow-sm shadow-black max-md:hidden"
                ...
                <div class="md:w-1/2 flex flex-col px-6">
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            <input type="text" class="border-2 text-clip border-gray-400 rounded-md h-32 w-full p-4">
                            <label
                    ...
                    <div class="space-y-4 mt-20 pt-2">
                        ...
                        <div class="relative">
                            <input type="text" class="border-2 text-clip border-gray-400 rounded-md h-44 w-full p-4">
                            <label
                    ...
                    <div class="flex flex-row space-x-3">
                        <button
                        class=" inline-block rounded-full py-3 w-full font-bold bg-white text-green-500 text-3xl mt-20 shadow-sm shadow-black md:hidden"
                        href="/jual-sampah">Batal</button>
                        <button
                            class=" inline-block rounded-full py-3 w-full font-bold bg-green-500 text-white text-3xl mt-20 shadow-sm shadow-black"
